...
curl -vvvsSf -X POST -H "Cluster-Environment-Name: demo/simple-cluster" http://localhost:7201/api/v1/services/m3aggregator/placement/init -d '{
    ...
    "instances": [
        {
            "id": "m3aggregator-rep-1-0:6000",
            "isolation_group": "availability-zone-a",
            "zone": "embedded",
            "weight": 100,
            "endpoint": "m3aggregator-rep-1-0.m3aggregator-rep-1.demo.svc:6000",
            "hostname": "m3aggregator-rep-1-0",
            "port": 6000
        },
        {
            "id": "m3aggregator-rep-2-0:6000",
            "isolation_group": "availability-zone-b",
            "zone": "embedded",
            "weight": 100,
            "endpoint": "m3aggregator-rep-2-0.m3aggregator-rep-2.demo.svc:6000",
            "hostname": "m3aggregator-rep-2-0",
            "port": 6000
        }
    ]
}'
...
# setting just load balancer address will work?
